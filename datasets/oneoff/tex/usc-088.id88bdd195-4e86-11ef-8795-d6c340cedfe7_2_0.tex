...
% # sent_id = usc-088.id88bdd195-4e86-11ef-8795-d6c340cedfe7_2_0
% # text = The term does not include a medical device that is surgically implanted, or the replacement of such device.
% # sent = the term does not include a medical device that is surgically implanted or the replacement of such device
% # tree_by = NOT_ASSIGNED (YYYY-MM-DD)
    ...
    [\Node{Head}{VP},edge={line width=1pt}
        ...
        [\Node{Comp}{Clause}
            [\Node{Head}{VP},edge={line width=1pt}
                [\Node{Head}{V},edge={line width=1pt}[include]]
                [\Node{Obj}{Coordination}
                    [\Node{Coordinate}{NP}
                        ...
                        [\Node{Head}{Nom},edge={line width=1pt}
                            [\Node{Head}{Nom},edge={line width=1pt}
                                [\Node{Mod}{AdjP}
                                    [\Node{Head}{Adj},edge={line width=1pt}[medical]]]
                                [\Node{Head}{N},edge={line width=1pt}[device]]]
                            [\Node{Mod}{Clause}
                                [\Node{Head}{VP},edge={line width=1pt}
                                    ...
                                    [\Node{Head}{VP},edge={line width=1pt}
                                        [\Node{Head}{VP},edge={line width=1pt}
                                            ...
                                            [\Node{Mod}{AdvP}
                                                [\Node{Head}{Adv},edge={line width=1pt}[surgically]]]]
                                        [\Node{Comp}{Clause}
                                            [\Node{Head}{VP},edge={line width=1pt}
                                                [\Node{Head}{V},edge={line width=1pt}[implanted,label={right:\p{{,}}}]]]]]]]]]
                    [\Node{Coordinate}{NP}
                        ...
                        [\Node{Head}{NP},edge={line width=1pt}
                            [\Node{Det}{DP}
                                [\Node{Head}{D},edge={line width=1pt}[the]]]
                            [\Node{Head}{Nom},edge={line width=1pt}
                                [\Node{Head}{N},edge={line width=1pt}[replacement]]
                                [\Node{Comp}{PP}
                                    ...
                                    [\Node{Obj}{NP}
                                        ...
                                        [\Node{Head}{Nom},edge={line width=1pt}
                                            [\Node{Head}{N},edge={line width=1pt}[device,label={right:\p{.}}]]]]]]]]]]]]]
        \end{forest}
